  ...
  return (
    <div className="w-full h-screen bg-black overflow-hidden">
      ...
      <nav className="bg-gray-900 border-b border-gray-800 px-4 py-2 flex items-center justify-between">
        <Link
          to="/"
          className="text-lg font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent hover:from-blue-300 hover:to-purple-400 transition-all"
        >
          AI Code Reviewer
        </Link>
        <Link
      ...
      <main className="h-[calc(100vh-49px)] w-full p-3 md:p-4 bg-black flex flex-col md:flex-row gap-3 md:gap-4">
